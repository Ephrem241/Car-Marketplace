    ...
    <div className="relative flex flex-col h-full overflow-hidden transition-all duration-300 bg-white border border-gray-200 rounded-2xl hover:shadow-2xl hover:scale-[1.02] dark:bg-gray-800/90 dark:border-gray-700 group">
      ...
      <div className="flex flex-col flex-1 p-6">
        ...
        <div className="flex justify-between items-center pt-4 mt-auto border-t border-gray-100 dark:border-gray-700/70">
          ...
          <Link
            href={`/cars/${car._id}`}
            className="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg transition-all hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700 hover:shadow-lg hover:-translate-y-0.5 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
          >
            View Details
          </Link>
        </div>
